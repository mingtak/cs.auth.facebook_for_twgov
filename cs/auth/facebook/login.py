...
#右列資訊暫停蒐集 ,user_about_me,user_friends,user_activities,create_note,photo_upload,publish_stream,publish_actions,status_update,publish_checkins,share_item,video_upload'
